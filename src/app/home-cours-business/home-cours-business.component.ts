...
@Component({
  selector: 'app-home-cours-business',
  templateUrl: './home-cours-business.component.html',
  styleUrls: ['./home-cours-business.component.css','../../assets/css/bootstrap.min.css']
})
export class HomeCoursBusinessComponent {
  creativeArts: any;
  ...
  constructor(private router:Router,private formationService:FormationService) {
    ...
    this.getCoursByCategoryCreativeArtsAndDesign("Business et Entrepreneuriat");
